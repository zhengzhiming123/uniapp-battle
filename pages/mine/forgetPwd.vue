<template>
	<view class="main">
		...
		<u-form class="form" :model="form" ref="uForm" :border-bottom="false" :errorType="errorType">
			...
			<u-form-item label="新密码" label-width="120" :label-style="labelStyle" prop="password" :border-bottom="false">
				<u-input v-model="form.password" type="password" placeholder="清设置新的登录密码" password-icon class="form-input" height="90" :custom-style="customStyle" />
			</u-form-item>
		</u-form>
		<u-button class="btn" type="primary" :ripple="true" @click="submit">确定</u-button>
	</view>
</template>
